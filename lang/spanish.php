...
$_LANG['clientareacontactsemailsinvoice'] = "Emails Prefacturas - Prefacturas y Recordatorios Comerciales";
...
$_LANG['clientareadescription'] = "Haga clic aquí para editar sus datos, ver información de Prefacturación o contratar servicios adicionales";
...
$_LANG['defaultbillingcontact'] = "Contacto de Prefacturación Predeterminado";
...
$_LANG['invoiceaddcreditdesc2'] = "Esto puede ser aplicado a la Prefactura utilizando el formulario a continuación.";
...
$_LANG['invoicenumber'] = "Prefactura nº";
...
$_LANG['invoices'] = "Mis Prefacturas";
...
$_LANG['invoicesdatecreated'] = "Fecha de la Prefactura";
...
$_LANG['invoicesinvoicedto'] = "Prefacturado a";
$_LANG['invoicesinvoicenotes'] = "Notas de la Prefactura";
$_LANG['invoicesnoinvoices'] = "No hay Prefacturas";
$_LANG['invoicesnotes'] = "Notas";
$_LANG['invoicesoutstandinginvoices'] = "Prefacturas Pendientes";
...
$_LANG['invoicestitle'] = "Prefactura N°";
...
$_LANG['invoicesview'] = "Ver Prefactura";
...
$_LANG['orderbillingcycle'] = "Ciclo de Prefacturación";
...
$_LANG['ordercompletebutnotpaid'] = "Atención! Su Pedido ha sido completado correctamente. Para activar los Productos/Servicios debe realizar el pago correspondiente.<br />Click en este enlace para ir a su Prefactura y realizar el pago.";
...
$_LANG['orderinvalidcodeforbillingcycle'] = "Este código no es aplicable a los ciclos de Prefacturación elegidos";
...
$_LANG['proformainvoicenumber'] = "Prefactura Proforma nº";
...
$_LANG['statsdueinvoicesbalance'] = "Balance de Prefacturas Impagadas";
...
$_LANG['upgradeproductlogic'] = "La actualización de precios se calcula a partir de un crédito de la parte no utilizada del plan actual y de Prefacturación del nuevo plan para el mismo período";
...
$_LANG['creditcardnostore'] = "Marque esta casilla si NO quiere que se guarden los datos de su tarjeta de crédito para cuando se vuelva a emitir Prefactura";
...
$_LANG['subaccountpermsinvoices'] = "Ver & Pagar Prefacturas";
...
$_LANG['masspaydescription'] = " A continuación hay un resumen de las Prefacturas seleccionadas y la deuda total para pagarlas en su totalidad. Para realizar el pago, por favor, únicamente seleccione el método de pago establecido más abajo.";
...
$_LANG['invoicepaymentpendingreview'] = "Gracias! Su pago se ha realizado correctamente y se aplicará a su Prefactura tan pronto como la revisión del proceso de 2CheckOut se haya completado.<br /><br />Esto puede tomar hasta un par de horas por lo que su paciencia es apreciada.";
...
$_LANG['cartchoosecycle'] = "Elija Ciclo de Prefacturación";
...
$_LANG['domainautorenewinfo'] = "La autorenovación ayuda a proteger tu dominio. Cuando está habilitada, te enviaremos automáticamente una Prefactura de renovación unas semanas antes de que tu dominio expire, y tu dominio será renovado en cuanto realices el pago.";
...
$_LANG['bundlewarningproductcycle'] = "El paquete seleccionado requiere que escojas el ciclo de Prefacturación '%s' para el producto %s para cualificarlo";
...
$_LANG['navbilling'] = "Prefacturación";
$_LANG['navinvoices'] = "Prefacturas";
...
$_LANG['creditcardyourinfo'] = "Información de Prefacturación";
...
$_LANG['availcreditbaldesc'] = "Tienes un crédito de %s y será aplicado automáticamente en las nuevas Prefacturas";
$_LANG['youhaveoverdueinvoices'] = "Tiene %s Prefactura(s) Vencida(s)";
$_LANG['overdueinvoicesdesc'] = "Para prevenir la interrupción del servicio, por favor, paga tus Prefacturas vencidas lo antes posible. %sPagar Ahora &raquo;%s";
$_LANG['supportticketsnoneopen'] = "Actualmente no hay ningún Ticket de Soporte abierto";
$_LANG['invoicesnoneunpaid'] = "Actualmente no hay Prefacturas sin pagar";
...
$_LANG['domainrenewexp'] = "Activa la autorenovación para que te enviemos una Prefactura de renovación automáticamente antes de que tu dominio expire.";
...
$_LANG['addfundsdescription'] = "Añade fondos a tu cuenta para evitar realizar muchas transacciones pequeñas y para pagar automáticamente las nuevas Prefacturas generadas.";
...
$_LANG['invoicefilename'] = "Prefactura-";
...
$_LANG['invoicesintro'] = "Su historial de Prefacturas con nosotros.";

$_LANG['sidebars']['viewAccount']['yourAccount'] = "Su Cuenta";
$_LANG['sidebars']['viewAccount']['myDetails'] = "Mis Detalles";
$_LANG['sidebars']['viewAccount']['billingInformation'] = "Información de Prefacturación";
...
$_LANG['billingdetails'] = "Detalles de Prefacturación";
$_LANG['homechooseproductservice'] = "Elija un Producto/Servicio para gestionar:";

$_LANG['invoicesdue'] = "Prefactura Vencida";
$_LANG['invoicesduemsg'] = "Usted tiene %s Prefactura(s) vencida(s) por el monto total de %s";
$_LANG['noinvoicesduemsg'] = "No tiene Prefacturas pendientes de pago en este momento.";
...
$_LANG['masspayintro'] = "Pagar todas las Prefacturas en una única y sencilla transacción";
...
$_LANG['clientAlerts']['invoicesUnpaid'] = "Usted tiene :numberOfInvoices Prefacturas(s) impaga(s). Pague ahora para evitar su preocupación.";
$_LANG['clientAlerts']['invoicesOverdue'] = "Usted tiene :numberOfInvoices Prefacturas(s) vencida(s) por el monto total de :balanceDue. Pague ahora para evitar interrupciones de servicio.";
...
$_LANG['clientHomePanels']['unpaidInvoices'] = "Prefacturas Pendientes";
$_LANG['clientHomePanels']['unpaidInvoicesMsg'] = "Usted tiene :numberOfInvoices Prefactura(s) impaga(s) por un monto total de :balanceDue. Pague ahora para evitar su preocupación.";
$_LANG['clientHomePanels']['overdueInvoices'] = "Prefacturas Vencidas";
$_LANG['clientHomePanels']['overdueInvoicesMsg'] = "Usted tiene :numberOfInvoices Prefactura(s) vencida(s) por el monto total de :balanceDue. Pague ahora para evitar interrupciones de servicio.";
...
$_LANG['upgradeSameProductMustExtendCycle'] = "Para actualizar su ciclo de Prefacturación, elija un ciclo que sea mayor que su ciclo de Prefacturación actual.";
...
$_LANG['billingOverview'] = "Información de Prefacturación";
...
$_LANG['billingAddress'] = "Dirección de Prefacturación";
...
$_LANG['orderForm']['enterPersonalDetails'] = "Por favor, introduzca sus datos personales y los datos de Prefacturación para comprar.";
...
$_LANG['orderForm']['billingAddress'] = "Dirección de Prefacturación";
...
$_LANG['orderForm']['promoCycles'] = "Vence después de :cycles período/s de Prefacturación";
...
$_LANG['sso']['summary'] = "Las aplicaciones de terceros aprovechan la funcionalidad de inicio de sesión simple para proporcionar un acceso directo a su cuenta de Prefacturación sin tener que volver a autenticar.";
$_LANG['sso']['disablenotice'] = "Es posible que desee desactivar esta funcionalidad si usted proporciona acceso a cualquier persona sobre las aplicaciones de terceros, para evitar que cualquier usuario sea capaz de acceder a su cuenta de Prefacturación.";
...
$_LANG['upgradeCreditDescription'] = "Cálculo basado en :daysRemaining días no utilizados de :totalDays días totales en el ciclo de Prefacturación actual.";
...
$_LANG['renewService']['hideShowServices']['hide'] = "Esconder Servicios no renovables";
$_LANG['renewService']['hideShowServices']['show'] = "Mostrar Servicios no renovables";

$_LANG['renewService']['statusInfo']['notSupported'] = "Este producto no admite renovaciones bajo demanda.";
$_LANG['renewService']['statusInfo']['nonRecurring'] = "Este es un servicio único que no utiliza prefacturación recurrente.";
$_LANG['renewService']['statusInfo']['outsideRenewal'] = "Este servicio no está dentro de su período de renovación.";
$_LANG['renewService']['statusInfo']['serviceStatus'] = "Este servicio está :serviceStatus. Las renovaciones requieren un estado Activo.";
$_LANG['renewService']['statusInfo']['unpaidInvoices'] = "El servicio tiene :unpaidInvoiceCount prefactura(s) impaga(s).";
$_LANG['renewService']['statusInfo']['metricUsage'] = "Este es un servicio facturado por uso que no admite renovaciones bajo demanda.";

$_LANG['renewServiceAddon']['titleAltSingular'] = "Renovación de Addon";
$_LANG['renewServiceAddon']['titleAltPlural'] = "Renovaciones de Addons";
...
$_LANG['validation']['date_format'] = "La :attribute no coincide con el formato :format.";
$_LANG['validation']['different'] = "La :attribute y :other deben ser diferentes.";
$_LANG['validation']['digits'] = "El :attribute debe ser :digits dígitos.";
$_LANG['validation']['digits_between'] = "El :attribute debe estar entre :min y :max dígitos.";
$_LANG['validation']['email'] = "La :attribute debe ser una dirección de correo electrónico válida.";
$_LANG['validation']['exists'] = "La :attribute seleccionada no es válida.";
$_LANG['validation']['filled'] = "El campo :attribute es requerido.";
$_LANG['validation']['image'] = "La :attribute debe ser una imagen.";
$_LANG['validation']['in'] = "La :attribute seleccionada no es válida.";
$_LANG['validation']['integer'] = "La :attribute debe ser un entero.";
$_LANG['validation']['ip'] = "La :attribute debe ser una dirección IP válida.";
$_LANG['validation']['json'] = "La :attribute debe ser una cadena JSON válida.";
$_LANG['validation']['max']['numeric'] = "La :attribute no puede ser mayor que :max.";
$_LANG['validation']['max']['file'] = "La :attribute no puede ser mayor que :max kilobytes.";
$_LANG['validation']['max']['string'] = "La :attribute no puede ser mayor que :max caracteres.";
$_LANG['validation']['max']['array'] = "La :attribute no puede tener más de :max elementos.";
$_LANG['validation']['mimes'] = "La :attribute debe ser un archivo de tipo: :values.";
$_LANG['validation']['min']['numeric'] = "La :attribute debe ser al menos :min.";
$_LANG['validation']['min']['file'] = "La :attribute debe ser al menos :min kilobytes.";
$_LANG['validation']['min']['string'] = "La :attribute debe ser al menos :min caracteres.";
$_LANG['validation']['min']['array'] = "La :attribute debe tener al menos :min elementos.";
$_LANG['validation']['not_in'] = "La :attribute seleccionada no es válida.";
$_LANG['validation']['numeric'] = "La :attribute debe ser un número.";
...
$_LANG['tax']['taxLabel'] = "Cédula/RUC/Pasaporte";
...
$_LANG['fraud']['countryMismatch'] = "El país de su dirección IP no coincide con el país de la dirección de Prefacturación que ingresó, por lo que lamentamos no poder aceptar su pedido.";
...
$_LANG['unpaidInvoiceAlert'] = "Tiene una Prefactura impaga. Pague ahora para evitar interrupciones en el servicio.";
$_LANG['overdueInvoiceAlert'] = "Tienes una Prefactura vencida.";
$_LANG['payInvoice'] = "Pagar Prefactura";
...
$_LANG['paymentMethodsManage']['addNewBillingAddress'] = "Agregar nueva dirección de Prefacturación";
...
$_LANG['subscription']['subscriptionWarning'] = "Las suscripciones activas a continuación se aplicarán a esta Prefactura automáticamente. Si el pago de una suscripción resulta en un pago en exceso, recibirá un crédito que se aplicará automáticamente a su próxima Prefactura.";
...
$_LANG['emailPreferences']['invoice'] = "Correos electrónicos de Prefacturas - Nuevas Prefacturas, recordatorios y avisos de vencimiento";
...
$_LANG['permissions']['descriptions']['invoices'] = "Permiso para ver y pagar Prefacturas";
