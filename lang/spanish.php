...
$_LANG['marketConnect']['nordvpn']['clientOutput']['3'] = "Si tienes preguntas sobre pedidos o prefacturación, ponte en contacto con nuestro equipo de soporte a través de :anchorOpenSubmit a Ticket:anchorClose.";
...
$_LANG['metrics']['billing'] = "Prefacturación";
$_LANG['metrics']['currentUsage'] = "Uso actual";
$_LANG['metrics']['explanation'] = "Este producto tiene cargos de prefacturación basados en el uso además del precio base. Las métricas de uso y su información de precios se muestran a continuación.";
...
$_LANG['renewService']['statusInfo']['metricUsage'] = "Este es un servicio prefacturado por el uso que no admite renovaciones a pedido.";
$_LANG['renewService']['statusInfo']['nonRecurring'] = "Se trata de un servicio único que no utiliza la prefacturación recurrente.";
...
$_LANG['renewService']['statusInfo']['unpaidInvoices'] = "El servicio tiene :unpaidInvoiceCount Prefacturas impagas.";
...
$_LANG['store']['ssl']['landingPage']['multiYear']['benefits']['b2'] = "Elimine la molestia de la prefacturación anual.";
